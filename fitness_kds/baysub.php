...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM bayrakli_musterileri');
        $sorgu->execute();
        $bayrakli_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($bayrakli_musterileri as $bm){?>
