    ...
    <div id="outer">
        ...
        <div id="content">
                <div id="secondContent" style="width:265px"></br></br>
                        ...
                        <p>Balçova Şubemizde 16 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
                ...
                $sorgu=$db->prepare('SELECT * FROM ekipman_balcova');
                $sorgu->execute();
                ...
                <div id="firstContent" style="width:500px">
                    ...
                    <h3>BALÇOVA ŞUBESİ EKİPMANLARI</h3>
