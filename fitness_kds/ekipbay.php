    ...
    <div id="outer">
        ...
        <div id="content">
                <div id="secondContent" style="width:265px"></br></br>
                        ...
                        <p>Bayraklı Şubemizde 19 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
                ...
                $sorgu=$db->prepare('SELECT * FROM ekipman_bayrakli');
                $sorgu->execute();
                $ekipman1=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.

                ?>
                <div id="firstContent" style="width:500px">

                    <h3>BAYRAKLI ŞUBESİ EKİPMANLARI</h3>
