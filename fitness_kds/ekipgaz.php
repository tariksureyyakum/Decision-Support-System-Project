    ...
    <div id="outer">
        ...
        <div id="content">
            ...
            <div id="secondContent" style="width:265px"></br></br>
                    <p>Gaziemir Şubemizde 15 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
            ...
            $sorgu=$db->prepare('SELECT * FROM ekipman_gaziemir');
            $sorgu->execute();
            ...
            <div id="firstContent" style="width:500px">
                    ...
                    <h3>GAZİEMİR ŞUBESİ EKİPMANLARI</h3>
