    ...
    <div id="outer">
        ...
        <div id="content">
                ...
                <div id="secondContent" style="width:265px"></br></br>
                        <p>Güzelbahçe Şubemizde 15 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
                ...
                $sorgu=$db->prepare('SELECT * FROM ekipman_guzelbahce');
                $sorgu->execute();
                ...
                <div id="firstContent" style="width:500px">
                    ...
                    <h3>GÜZELBAHÇE ŞUBESİ EKİPMANLARI</h3>
