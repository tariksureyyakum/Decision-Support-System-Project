    ...
    <div id="outer">
        ...
        <div id="content">
                ...
                <div id="secondContent" style="width:265px"></br></br>
                        <p>Karabağlar Şubemizde 16 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
                ...
                $sorgu=$db->prepare('SELECT * FROM ekipman_karabaglar');
                $sorgu->execute();
                $ekipman3=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        
                ?>
                <div id="firstContent" style="width:500px">

                    <h3>KARABAĞLAR ŞUBESİ EKİPMANLARI</h3>
