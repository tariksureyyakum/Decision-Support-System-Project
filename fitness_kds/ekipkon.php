...
<body>
    <div id="outer">
        ...
        <div id="content">
                    ...
                    <p>Konak Şubemizde 20 adet ekipman bulunmaktadır. Ekipman tam olduğundan ekleme yapılamaz!</p></br></br>
                    
                    <a href="gelecek2.php">Planlamalara göz at.</a>
                    </div>
                    <?php
 
                    $sorgu=$db->prepare('SELECT * FROM ekipman_konak');
                    $sorgu->execute();
                    ...
                    <div id="firstContent" style="width:500px">
                        ...
                        <h3>KONAK ŞUBESİ EKİPMANLARI</h3>
