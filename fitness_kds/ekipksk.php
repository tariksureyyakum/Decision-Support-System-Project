    ...
    <div id="outer">
        ...
        <div id="content">
                ...
                <div id="secondContent" style="width:265px"></br></br>
                        ...
                        <p>Karşıyaka Şubemizde 17 adet ekipman bulunmaktadır. Ekipman eklemek için</p>
                ...
                $sorgu=$db->prepare('SELECT * FROM ekipman_karsiyaka');
                $sorgu->execute();
                ...
                <div id="firstContent" style="width:500px">
                    ...
                    <h3>KARŞIYAKA ŞUBESİ EKİPMANLARI</h3>
