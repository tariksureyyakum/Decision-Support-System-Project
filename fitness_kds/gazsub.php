...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM gaziemir_musterileri');
        $sorgu->execute();
        $gaziemir_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($gaziemir_musterileri as $gam){?>
