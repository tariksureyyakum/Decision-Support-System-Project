...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM guzelbahce_musterileri');
        $sorgu->execute();
        $guzelbahce_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($guzelbahce_musterileri as $gm){?>
