...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM karabaglar_musterileri');
        $sorgu->execute();
        $karabaglar_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($karabaglar_musterileri as $km){?>
