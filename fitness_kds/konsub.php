...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM konak_musterileri');
        $sorgu->execute();
        $konak_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($konak_musterileri as $kon){?>
