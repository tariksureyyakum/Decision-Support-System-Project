...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM karsiyaka_musterileri');
        $sorgu->execute();
        $karsiyaka_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($karsiyaka_musterileri as $ksk){?>
