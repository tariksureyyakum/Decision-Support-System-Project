...
<body>
    <div id="outer">
        ...
        $sorgu=$db->prepare('SELECT * FROM narlidere_musterileri');
        $sorgu->execute();
        $narlidere_musterileri=$sorgu-> fetchAll(PDO::FETCH_OBJ);//object olarak verilerimizi çekiyoruz.
        ...
        <div id="content">
                ...
                <div id="firstContent" style="width:713px">
                    ...
                    <tr>
                        ...
                        <?php
                        foreach($narlidere_musterileri as $nar){?>
